# -*- coding: utf-8 -*-
"""🐱 TREINO DE GATOS - 3 CLASSES (GRIMACE SCALE) - VERSÃO LOCAL"""
...
if not os.path.exists(train_dir) or not os.path.exists(val_dir):
    raise FileNotFoundError(
        ...
        f"e {val_dir}\n"
        f"Certifique-se de que o dataset está em dataset/cats/train/0/,1/,2/ ..."
    )
...
axes[0].set_title('🐱 GATOS (Grimace 3 classes) - Acurácia', fontweight='bold')
...
axes[1].set_title('🐱 GATOS (Grimace 3 classes) - Loss', fontweight='bold')
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_MODELS_DIR, "cats_grimace_training.png"), dpi=150)
plt.show()
...
print("\n" + "="*60)
print("✅ TREINAMENTO DE GATOS (3 classes) CONCLUÍDO!")
print("="*60)
